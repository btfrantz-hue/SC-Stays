...
function WhatsAppButton() {
  return (
    <a
      ...
      onClick={() => trackWhatsappClick({ page: "parceiros", button: "floating" })}
...
function LeadForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setError("");
    submitProposalLead({ data: form }).catch((err) => {
      console.error("Falha ao salvar lead de proposta:", err);
    });
      ...
      <div className="py-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-ink">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackWhatsappClick({ page: "parceiros", button: "form_proposta_fallback" })}
    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="mt-4">
        ...
        <select required value={form.situacao} onChange={set("situacao")} className={`${inputClass} appearance-none`}>
          ...
          <option value="Tenho gestora, quero trocar">Tenho gestora atual e quero trocar</option>
          <option value="Tenho gestora, quero melhorar">Tenho gestora atual e quero melhorar os resultados</option>
          <option value="Uso só para mim, ainda não aluguei">Uso o imóvel só para mim, ainda não aluguei</option>
          <option value="Em construção ou reforma">Imóvel em construção ou reforma</option>
          <option value="Prefiro não informar">Prefiro não informar agora</option>
        </select>
      </div>
      <div className="mt-6">
        <button
...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-cream text-ink">
        ...
        <div className="bg-navy py-10">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsappClick({ page: "parceiros", button: "cta_intermediario" })}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackWhatsappClick({ page: "parceiros", button: "footer_contato" })}
      ...
      {sections.whatsapp_flutuante && <WhatsAppButton />}
    </div>
  );
}
